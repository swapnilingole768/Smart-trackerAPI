	...
	public void distributorAdminLoginTest() {
	 ...
	 @Test(priority = 2, description = "Create Location", dependsOnMethods = { "distributorAdminLoginTest" })
	    public void createCompanyLocationTest() {
	        ...
	        fields.put("company_name", "STG services");
	        fields.put("company_address", "Bhor");
	        fields.put("company_city", "Satara");
	        fields.put("company_state", "Maharashtra");
	        fields.put("company_pincode", "421012");
	        ...
	        Response response = given()
	                ...
	                .body(fields)
	                .when()
	                .post(auth.API_KEY + "/maintainers/company");
	 ...
	 @Test(priority = 3, description = "Update Location", dependsOnMethods = { "createCompanyLocationTest" })
	    public void updateCompanyLocationTest() {
	        ...
	        updatedFields.put("company_address", cred.getGasSize() +"shashtri nagar");
	        updatedFields.put("company_city", "Satara");
	        ...
	        Response response = given()
	                ...
	                .body(updatedFields)
	                .when()
	                .put(auth.API_KEY + "/maintainers/company/" + companyLocationId);
	 ...
	 @Test(priority = 3, description = "Get Location", dependsOnMethods = { "createCompanyLocationTest" })
	    public void getCompanyLocationTest() {
	    	io.restassured.response.Response response = given() // Include JWT token in the request header
					.cookie("jwt", auth.JWT_COOKIE) // Include JWT token in Cookie header
					.contentType("application/json").when().get(auth.API_KEY + "/maintainers/company");
